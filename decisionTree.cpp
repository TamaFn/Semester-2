...
struct BST {
    ...
    void insertTree(){
        char text1[] = "Ingin mulai permainan? (yes/no/exit)";
        ...
        char text7[] = "Pilihan anda hanya senjata Claymore. Ketik yes apabila ingin meneruskan";
        char text8[] = "Senjata anda adalah Bow. \nKetik selesai untuk keluar : ";
        char text9[] = "Senjata anda adalah Catalyst. \nKetik selesai untuk keluar : ";
        ...
        char text10[] = "Senjata anda adalah Sword. \nKetik selesai untuk keluar : ";
        char text11[] = "Senjata anda adalah Spear. \nKetik selesai untuk keluar : ";
        char text12[] = "Senjata anda adalah Claymore. \nKetik selesai untuk keluar : ";
